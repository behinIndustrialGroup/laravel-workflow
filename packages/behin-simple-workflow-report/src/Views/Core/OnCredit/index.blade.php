                        ...
                        <tr @if ($onCredit->is_passed) style="background-color: #d4edda;" @endif>
                            ...
                            <td>
                                ...
                                @else
                                    ...
                                    <button class="btn btn-sm " onclick="open_view_model_form('25933dfe-48fb-421f-a520-dbb468848298', '9e6d25a3-df4b-444c-a600-b4805847bb17', '{{ $onCredit->id  }}', 'QRcpdfla1CGfMj9v')">
                                        ویرایش
                                    </button>
                                @endif
                            </td>
