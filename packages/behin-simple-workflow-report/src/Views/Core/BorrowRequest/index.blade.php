                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-bordered align-middle">
                            ...
                            <tbody>
                                            ...
                                            <form method="POST"
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" name="delivered_at"
                                                        class="form-control persian-datetime" placeholder="تاریخ تحویل"
                                                        required>
                                                </div>
                                                <div class="col-md-6">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center text-muted">درخواستی برای تحویل وجود ندارد.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
                            ...
                            <tbody>
                                @forelse ($deliveredRequests as $request)
                                    <tr>
                                        <td>
                                            <div>{{ $request->item_name }}</div>
                                            <div class="text-muted small">درخواست‌کننده: {{ getUserInfo($request->requester_id)?->name ?? '' }}</div>
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center text-muted">درخواست تحویل داده‌شده‌ای برای
                                            ویرایش وجود ندارد.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-bordered align-middle">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center text-muted">درخواستی در انتظار تایید نیست.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
